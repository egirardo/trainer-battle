        ...
        <section className={className} aria-label="How to play">
            ...
            <article className={styles.contentContainer}>
                ...
                <div className={styles.contentSection}>
                    ...
                    <p>Each <span className={styles.accentText}>PvP</span> win earns you a badge. Collect <span className={styles.accentText}>3 badges</span> to unlock a fight against the final boss. </p>
