        ...
        <section className={styles.section}>
            ...
            <article className={styles.contentContainer}>
                <div className={styles.contentSection}>
                    ...
                    <p id="cashout-requirements">To cash out you must <span className={styles.accentText}>defeat the boss</span> and have earned more credits than your starting balance.</p>
                ...
                <div className={styles.btnContainer}>
                    ...
                    <Button
                        variant="danger"
                        disabled={!canCashOut}
                        aria-describedby={!canCashOut ? 'cashout-requirements' : undefined}
