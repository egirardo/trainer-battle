        ...
        <div className={styles.info}>
          ...
          <dl className={styles.stats}>
            ...
            <div className={styles.statRow}>
              ...
              <dd className={styles.statValue}>{Math.min(trainer.wins, 3) + (playerStats?.boss_beaten ? 1 : 0)} / 4</dd>
            </div>
          </dl>
        </div>
      </div>

      <BadgeRow wins={trainer.wins} bossBeaten={playerStats?.boss_beaten ?? false} />
    </div>
  );
}
